...
> This project is my first attempt integrating React, Rails and Webpack to create a simple app making API calls.
...
```sh
  git clone https://github.com/DaveZag/hello-react-rails.git
```
